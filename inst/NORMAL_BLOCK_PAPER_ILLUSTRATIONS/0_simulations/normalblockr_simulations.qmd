...
one_simulation <- function(simu, n, p, Q, d, kappa,
  ...
  res_fixed_blocks_BIC <- get_measures(myNB_fixed_blocks, true_param, "BIC", TRUE)
  ...
  res_heuristic_fixed_blocks <- get_measures(heuristic_fixed_blocks, true_param,
  ...
  args_heuristic_sigma_cl$control  <- NB_control(verbose = FALSE,
                                                heuristic = TRUE,
                                                clustering_approx = "covariance")
  
  heuristic_sigma_cl      <- do.call(normal_block, args_heuristic_sigma_cl)

  res_heuristic_sigma_cl  <- get_measures(heuristic_sigma_cl, true_param,
  ...
  args_heuristic_residuals_cl$control  <- NB_control(verbose = FALSE,
                                                     heuristic = TRUE,
                                                     clustering_approx = "residuals")

  heuristic_residuals_cl  <- do.call(normal_block, args_heuristic_residuals_cl)
  res_heuristic_residuals_cl <- get_measures(heuristic_residuals_cl, true_param,
                                             observed_blocks = FALSE, heuristic = TRUE)
